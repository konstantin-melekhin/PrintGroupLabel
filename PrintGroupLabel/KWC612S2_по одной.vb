...
Public Class KWC612S2_по_одной
   

        Dim SQL As String
    Private Sub KWC612S2_по_одной_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub TB_ScanSN_KeyDown(sender As Object, e As KeyEventArgs) Handles TB_ScanSN.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            If SearchSNList.Count <> 0 Then
                ...
                If SNArray.Count = 7 Then

                    LabelPallet(SNArray(0))
    ...
    Private Function SerchSN(Sn As String) As ArrayList
        SQL = "use fas
